  ...
  useEffect(() => {
    ...
    async function completeRedirectLogin() {
      try {
        ...
        if (!ignore) {
          setError(getAuthErrorMessage(error, 'Google sign-in failed. Please try again.'));
          ...
          <div>
            ...
            <div className="mt-20 max-w-md">
              ...
              <p className="mt-6 text-[15px] leading-7 text-[#c7c1b8]">
                BuildDesk is designed for people who prefer clarity over noise and structure over gimmicks.
              </p>
            </div>
          </div>
        ...
        <main className="flex items-center justify-center px-4 py-10 sm:px-6">
          <div className="w-full max-w-[440px] rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-[var(--shadow-subtle)] sm:p-10">
            <div className="mb-8">
              ...
              <h2 className="mt-6 font-display text-[36px] leading-none text-[var(--color-text-primary)]">
                Welcome back
              </h2>
              <p className="mt-3 text-[14px] leading-7 text-[var(--color-text-secondary)]">
                Sign in to continue your saved BuildDesk conversations.
              </p>
            </div>
            ...
            <p className="mt-6 text-center text-[14px] text-[var(--color-text-secondary)]">
              ...
              <Link href="/signup" className="font-medium text-[var(--color-text-primary)] hover:underline">
                Create one
              </Link>
            </p>
          </div>
